...
//--------------------------------------------------InitData-------------------------------------
		         for (var i = 0; i < totalPoints; i++) {
				  ...
				  datasets.light0.data.push(temp);
				  datasets.noise0.data.push(temp);
				  datasets.smoke0.data.push(temp);     
		...
		socket.on("message", function (data) {	
				  ...
				  datasets.light0.data.shift();
				  datasets.noise0.data.shift();
				  datasets.smoke0.data.shift();     
